...
Региональный парсер `RussiaBaseRegionalParser` предназначен для сбора данных о ценах на топливо по регионам России с сайта russiabase.ru. В отличие от стандартного парсера, который собирает данные по отдельным АЗС, региональный парсер создает сводную таблицу с данными по регионам.
